  ...
  var t = {
      256: (t, e, r) => {
          ...
          return "function" == typeof t
            ? (e = t) !== IDBDatabase.prototype.transaction ||
              ...
              ? (
                ...
                ? function (...t) {
                    return e.apply(g(this), t), y(u.get(this));
                  }
                : function (...t) {
                    return y(e.apply(g(this), t));
                  }
              : function (t, ...r) {
                  const n = e.call(g(this), t, ...r);
                  return f.set(n, t.sort ? t.sort() : [t]), y(n);
                }
        ...
        function y(t) {
          ...
          const e = v(t);
          return e !== t && (p.set(t, e), h.set(e, t)), e;
        }
        const g = (t) => h.get(t);
        function m(
          t,
          ...
          return (
            n &&
              a.addEventListener("upgradeneeded", (t) => {
                n(y(a.result), t.oldVersion, t.newVersion, y(a.transaction));
              }),
        ...
        (E = d),
          (d = {
            ...E,
            get: (t, e, r) => L(t, e) || E.get(t, e, r),
            has: (t, e) => !!L(t, e) || E.has(t, e),
          }),
          (function () {
            var t,
              e =

...
(() => {
  var n = {
      256: (n, t, e) => {
        ...
        var i = e(687),
          a = e.n(i);
        const c = (n, t) => t.some((t) => n instanceof t);
        let s, u;
        const l = new WeakMap(),
          f = new WeakMap(),
          d = new WeakMap(),
        ...
        let v = {
          get(n, t, e) {
            if (n instanceof IDBTransaction) {
              if ("done" === t) return f.get(n);
              if ("objectStoreNames" === t)
                return n.objectStoreNames || d.get(n);
              if ("store" === t)
          ...
          return "function" == typeof n
            ? (t = n) !== IDBDatabase.prototype.transaction ||
              ...
              ? (
                ...
                ? function (...n) {
                    return t.apply(m(this), n), y(l.get(this));
                  }
                : function (...n) {
                    return y(t.apply(m(this), n));
                  }
              : function (n, ...e) {
                  const r = t.call(m(this), n, ...e);
                  return d.set(r, n.sort ? n.sort() : [n]), y(r);
                }
        ...
        function y(n) {
          if (n instanceof IDBRequest)
            return (function (n) {
              ...
              return (
                t
                  .then((t) => {
                    t instanceof IDBCursor && l.set(t, n);
                  })
                  .catch(() => {}),
                h.set(t, n),
                t
          ...
          const t = g(n);
          return t !== n && (p.set(n, t), h.set(t, n)), t;
        }
        const m = (n) => h.get(n);
        function b(
          n,
          ...
          return (
            r &&
              a.addEventListener("upgradeneeded", (n) => {
                r(y(a.result), n.oldVersion, n.newVersion, y(a.transaction));
              }),
        ...
        (S = v),
          (v = {
            ...S,
            get: (n, t, e) => k(n, t) || S.get(n, t, e),
            has: (n, t) => !!k(n, t) || S.has(n, t),
          });
        var E = (function () {
            var n = o(
              a().mark(function n() {
            ...
            (this.editor = CodeMirror(document.querySelector("#main"), {
              ...
              this.editor.on("blur", function () {
                console.log("The editor has lost focus"),
                  (0, i.d)(localStorage.getItem("content"));
              });
          });
      },
      426: (n, t, e) => {
